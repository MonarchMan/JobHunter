...
import { normalizeRecruitmentCategory } from '../normalization/recruitment-category.js';
import {
  SourceError,
...
export interface ScriptedAdapterDefinition {
  ...
  readonly fixedRecruitmentCategory?: 'internship' | 'campus' | 'social';
    ...
    normalize(input, context) {
      return Promise.resolve().then(() => {
        ...
        const recruitmentCategory =
          definition.fixedRecruitmentCategory ??
          recruitmentCategoryFor(raw, definition.recruitmentType);
        return {
