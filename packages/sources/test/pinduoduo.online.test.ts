...
describe.skipIf(!online)('Pinduoduo controlled online smoke', () => {
  it('discovers the anonymous internship list', async () => {
    const config = pinduoduoConfigSchema.parse({ pageSize: 100 });
    const context: DiscoverContext<PinduoduoConfig> = {
      companyId: parseId('018f0000-0000-7000-8000-000000000105', 'Company'),
      sourceId: parseId('018f0000-0000-7000-8000-000000000205', 'JobSource'),
    ...
    for await (const event of createPinduoduoAdapter().discover(context)) {
