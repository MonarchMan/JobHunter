...
后续平台里程碑 P1 由 `028-recruitment-platforms` 扩展招聘平台按需读取与正式职位管理，不改变上述历史首期基线；自动投递和多用户仍不在范围内。平台架构已确定，尚未实现或声明 supported。
...
| `025-resume-template-export`        | 多模板简历制作与本地 PDF/HTML 导出       | R2     | 002, 003, 007, 011, 014, 022                |
| `026-official-source-wave-two`      | 快手、B站、滴滴、携程与米哈游官网接入    | R1     | 004, 005, 016, 017, 018, 019                |
| `027-interactive-architecture`      | 可编辑、可离线浏览的交互架构文档         | 文档   | 000、011                                    |
| `028-recruitment-platforms`         | 平台按需读取、会话借用与统一正式职位管理 | P1     | 001, 002, 003, 004, 005, 009, 011, 012, 018 |
