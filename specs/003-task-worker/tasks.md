...
- [x] **WRK-T019** 覆盖锁冲突后的领取/调度恢复、心跳与提交安全，以及维护期间的及时退出。（WRK-009）

- [x] **WRK-T018** 持久化详情批次索引字段并回填重试根，将普通任务与来源运行详情改为批量读取。（WRK-020）

> 显式覆盖：WRK-001, WRK-002, WRK-003, WRK-004, WRK-005, WRK-006, WRK-007, WRK-008, WRK-009, WRK-010, WRK-011, WRK-012, WRK-013, WRK-014, WRK-015, WRK-016, WRK-017, WRK-018, WRK-019, WRK-Q01, WRK-Q02, WRK-Q03
...
- [x] **WRK-T017** 将任务诊断的批次计数与分页合并为单次物化聚合，并覆盖空结果和越界页回落。（WRK-019）
